...
<iframe src="https://yandex.ru/map-widget/v1/-/CBU7EScyPD" width="560" height="400" frameborder="0"></iframe>
 ...
 ';
		...
		if(!isset($_GET['short'])){		
			...
			if($_GET['page']>1){
				$lim=9*($_GET['page']-1);
				$query="SELECT * FROM `singleline` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT ".$lim.",9";}else{
				$query="SELECT * FROM `singleline` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT 0,9";
			}
		}else{
			switch($_GET['short']){
				case "price":
		...
		if($_GET['page']>1){
			$lim=9*($_GET['page']-1);
			$query="SELECT * FROM `batter` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT ".$lim.",9";}else{
			$query="SELECT * FROM `batter` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT 0,9";}
		...
		if($_GET['page']>1){
			$lim=9*($_GET['page']-1);
			$query="SELECT * FROM `singl` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT ".$lim.",9";}else{
			$query="SELECT * FROM `singl` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT 0,9";}
		...
		if(!isset($_GET['short'])){
			if($_GET['page']>1){
				$lim=9*($_GET['page']-1);
				$query="SELECT * FROM `balls` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT ".$lim.",9";}else{
				$query="SELECT * FROM `balls` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT 0,9";	 
			}
		}else{
			switch($_GET['short']){
				case "price":
		...
		if($_GET['page']>1){
			$lim=9*($_GET['page']-1);
			$query="SELECT * FROM `scenepir` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT ".$lim.",9";}else{
			$query="SELECT * FROM `scenepir` WHERE price>=".$minp." AND price<=".$maxp." AND diameter>=".$mind." AND diameter<=".$maxd." LIMIT 0,9";		 
		}
	...
	/*echo'<div id="filter1">
 <div id="filter2"><p>
<form id="fltr" method="post" action="'.$_SERVER['REQUEST_URI'].'">
  <label for="amountprice">Цена:</label></br>
  <input type="text" name="amountprice" id="amountprice" form="fltr" readonly style="border:0; color:#183d87; font-weight:bold;">
</p> 
<div id="slider-range-price"></div></br>
 <p>
  <label for="amountdiameter">Калибр:</label></br>
  <input  type="text" name="amountdiameter" id="amountdiameter" form="fltr"  readonly style="border:0; color:#183d87; font-weight:bold;">
</p> 
<div id="slider-range-diameter"></div>
</div>
<div id="okfilter">
<input type="image" src="images/accept.png" width="210px" height="40px" alt="Отправить">
</div>
 </form>
</div>';*/
	...
	if($rowcount2>0){
		do{ 
			...
			switch($count){
				...
				<div id="product_discr">
				<div id="product_price">
				<span class="letter"> <b>Цена:</b></span><b><span class="letter2">'.$row['price'].'</span></b><span class="letter"><b>р</b></span> 
				</div>
				</br>
				<table class="table">
				<tbody>
				<tr>
				<td></br><span class="letter"> <b>Калибр:</b></span></td>
				<td></br><b><span class="letter2">'.$row['diameter'].'</span><b><span class="letter"><b>"</b></span></td>
				</tr>
				<!--<tr>
				<td><span class="letter"><b>Высота:</b></span></td>
				<td><span class="letter2">20 </span><span class="letter"><b>м</b></span></td>
				...
				<tr>
				<td><span class="letter"> <b>Объем:</b></span></td>
				<td><b><span class="letter2">'.$row['amount'].'</span></b><span class="letter"><b> м³</b></span></td>
				</tr>
				<tr>
				<td><span class="letter"><b>Вес:</b></td></span>
				<td><b><span class="letter2">'.$row['weight'].'</span> </b><span class="letter"><b> кг</></span></td>
				</tr>
				<tr>
				</tbody>
				</table>
				...
				<div id="product_discr">
				<div id="product_price">
				<span class="letter"> <b>Цена:</b></span><span class="letter2"><b>'.$row['price'].'</b></span><span class="letter"><b>р</b></span> 
				</div>
				</br>
				<table class="table">
				<tbody>
				<tr>
				<td></br><span class="letter"> <b>Калибр:</b></span></td>
				<td></br><span class="letter2"><b>'.$row['diameter'].'</b></span><span class="letter"><b>"</b></span></td>
				</tr>
				<!--<tr>
				<td><span class="letter"><b>Высота:</b></span></td>
				<td><span class="letter2">20 </span><span class="letter"><b>м</b></span></td>
				...
				<tr>
				<td><span class="letter"> <b>Объем:</b></span></td>
				<td><span class="letter2"><b>'.$row['amount'].'</b></span><span class="letter"><b> м³</b></span></td>
				</tr>
				<tr>
				<td><span class="letter"><b>Вес:</b></span></td>
				<td><span class="letter2"><b>'.$row['weight'].'</b></span><span class="letter"><b> кг</></span></td>
				</tr>
				<tr>
				</tbody>
				</table>
